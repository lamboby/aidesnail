package com.boby.aidesnail.itrustoor;
...
import com.boby.aidesnail.itrustoor.R;
import com.boby.aidesnail.itrustoor.HttpUtil.HttpCallbackListener;
...
public class MainActivity extends Activity {
		...
		btncreatebarcode.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try {
					...
					String contentString="<sid>"+schoolid+"</sid>http://www.itrustoor.com";
					if (!contentString.equals("")) {
						...
						Toast.makeText(MainActivity.this, "学校编号不能为空",
								Toast.LENGTH_SHORT).show();
					}
	...
	protected void saveBitmap() {
		...
		try {
			...
			String fileName = tschoolfullname.getText().toString() + ".png";
			...
			file.getAbsolutePath(),tschoolshort.getText().toString(), "");
			...
			final OSSData data = ossService.getOssData(bucket, schoolid+ "barcode.png");
			...
			try {
				...
				if (resObject.getInt("Code") == 0) {
					...
					case 2:
						...
						break;
					case 4:
						Toast.makeText(MainActivity.this, "二维码成功上传至OSS服务器", 0)
								.show();
						break;
					case 5:
						jsonArray = new JSONObject(response)
